...
// Product images are controlled in the Markdown files under content/products/.
// To change a product photo later, replace the local file in public/images/products/
// and update the coverImage/images paths in the matching product Markdown file.
// Example: coverImage: "/images/products/mug.jpg"
